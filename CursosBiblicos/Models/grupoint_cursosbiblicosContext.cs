...
{
    public partial class grupoint_cursosbiblicosContext : DbContext
    {
        public grupoint_cursosbiblicosContext()
        {
        }

        public grupoint_cursosbiblicosContext(DbContextOptions<grupoint_cursosbiblicosContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=104.194.9.141;port=3306;user=grupoint_proyecto_api;password=cftsa@2023;database=grupoint_cursosbiblicos", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.6.15-mariadb"));
            }
        }
